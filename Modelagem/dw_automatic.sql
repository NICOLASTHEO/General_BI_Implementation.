...
ALTER TABLE `DIM_PRODUTO` ADD FOREIGN KEY (`IDCATEGORIA`) REFERENCES `DIM_CATEGORIA`(`IDCATEGORIA`);
ALTER TABLE `FATO` ADD FOREIGN KEY (`IDVENDEDOR`) REFERENCES `DIM_VENDEDOR`(`IDSK`);
ALTER TABLE `FATO` ADD FOREIGN KEY (`IDNOTA`) REFERENCES `DIM_NOTA`(`IDSK`);
ALTER TABLE `FATO` ADD FOREIGN KEY (`IDFORMA`) REFERENCES `DIM_FORMA`(`IDSK`);
ALTER TABLE `FATO` ADD FOREIGN KEY (`IDCLIENTE`) REFERENCES `DIM_CLIENTE`(`IDSK`);
ALTER TABLE `FATO` ADD FOREIGN KEY (`IDPRODUTO`) REFERENCES `DIM_PRODUTO`(`IDSK`);
ALTER TABLE `FATO` ADD FOREIGN KEY (`IDFORNECEDOR`) REFERENCES `DIM_FORNECEDOR`(`IDSK`);
ALTER TABLE `FATO` ADD FOREIGN KEY (`IDTEMPO`) REFERENCES `DIM_TEMPO`(`IDSK`);